      ...
      <div className="container mx-auto px-4 py-3 sm:py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          {isSignedIn ? (
            ...
            <div>
              {/* The wrapper components SignInButton and SignUpButton handles the onclick functionalities, the authentication stuff
            Button from shadcn is the UI represent this component */}
              <SignInButton>
                <Button
                  variant="ghost"
                  size="sm"
